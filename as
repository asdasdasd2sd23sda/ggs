...
local _aimsp_settings; _aimsp_settings = {
    ...
    toggle = {
        r_mouse_button = false, -- makes you have to hold right mouse button, keybind will no longer work
    ...
    smoothness = 8, -- anything over 5 = aim assist,  1 = lock on (using 1 might get u banned)
    fov_size = 100; -- <450 = safezone
